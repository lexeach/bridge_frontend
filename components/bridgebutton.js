...
export function Bridgebutton(value) {
  ...
  const handleClick = async () => {
    ...
    try {
      ...
      await writeContract({
        abi,
        address: "0x8D7BC9cE6249C32c67fb9b81A83840FF72919084", // "0xBD933Db03dA178059079590B50b8e2bbE09313b0",
  ...
  const handleClick2 = async () => {
    ...
    try {
      ...
      await writeContract({
        abi,
        address: "0xb1e4E35D059fB6c5A34493981E24EDf3d5044647", // "0x617c5814f9c52e3768FD233088A01cc6dE25c58A",
        functionName: "lockTokens",
