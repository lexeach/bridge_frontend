...
export function ApproveToken(weiAmount) {
  ...
  const result = useReadContract({
    ...
    args: [
      address, // "0x2373a942FEbC0ee428b266bDD58275794E7f1553", // user address
      "0xaf8f027582d2b0f2E0F35d78b79f5a450f037439", // "0xC5052054DBDC35f84D279CB321bE98480d807f6F", //BSC  bridge contract address
    ],
  });
  result.data;
  ...
  const handleApprove2 = async () => {
    try {
      ...
      await writeContract({
        ...
        functionName: "approve",
        args: [
          "0xaf8f027582d2b0f2E0F35d78b79f5a450f037439", // BSC contract address
